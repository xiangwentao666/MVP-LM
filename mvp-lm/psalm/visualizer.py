...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions, threshold=0.1):
        ...
        scores = predictions.scores.cpu() if predictions.has("scores") else None
        classes = predictions.pred_classes.cpu().tolist() if predictions.has("pred_classes") else None
        ...
        classes = classes[np.array(keep)] if classes is not None else None
